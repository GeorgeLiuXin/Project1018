...
namespace XWorld
{
    ...
    public class CombatCalculationEditor : Editor
    {
        public static void ShowEditor()
        {
            CombatCalculationEditorWindow window = EditorWindow.GetWindow<CombatCalculationEditorWindow>();
            if (window)
            {
                window.ShowUtility();
    ...
    public class CombatCalculationEditorWindow : EditorWindow
    {
