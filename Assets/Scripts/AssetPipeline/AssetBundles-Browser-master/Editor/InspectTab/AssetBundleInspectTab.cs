...
namespace Galaxy.AssetBundleBrowser
{
    ...
    internal class AssetBundleInspectTab
    {
        ...
        internal void OnEnable(Rect pos, EditorWindow parent)
        {
            ...
            string dataPath = BuildHelper.CheckConfigPath(BuildHelper.INSPECT_NAME);
            //LoadData...
            ...
            if (File.Exists(dataPath))
            {
                using (FileStream file = File.Open(dataPath, FileMode.Open))
                {
                    ...
                    {
                        this.m_Data = LitJson.JsonMapper.ToObject<InspectTabData>(tr);
                    }
                }
            }
        ...
        internal void OnDisable()
        {
            ...
            using (FileStream file = File.Create(dataPath))
            {
                using (StreamWriter sw = new StreamWriter(file))
                {
                    ...
                    jw.PrettyPrint = true;
                    LitJson.JsonMapper.ToJson(this.m_Data, jw);
                }
            }
        }
        ...
        internal class InspectTabData
        {
            ...
            // for json
            public List<string> BundlePaths1
            {
                get
                {
            ...
            public List<BundleFolderData> BundleFolders1
            {
                get
                {
                    return m_BundleFolders;
                }

                set
                {
                    m_BundleFolders = value;
                }
            }
