...
namespace Galaxy.AssetBundleBrowser
{
    internal class AssetListTree : TreeView
    {
        ...
        private static MultiColumnHeaderState.Column[] GetColumns()
        {
            ...
            retVal[1].headerContent = new GUIContent("Bundle名字", "Bundle name. 'auto' means asset was pulled in due to dependency");
            ...
            retVal[2].headerContent = new GUIContent("大小(仅供参考)", "Size on disk");
            retVal[2].minWidth = 40;
            retVal[2].width = 75;
