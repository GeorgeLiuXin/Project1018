...
namespace Galaxy.AssetBundleBrowser.AssetBundleModel
{
    ...
    internal class BundleDataInfo : BundleInfo
    {
        ...
        internal override void RefreshAssetList()
        {
            ...
            var assets = AssetBundleModel.Model.DataSource.GetAssetPathsFromAssetBundle(m_Name.fullNativeName + ".dat");
