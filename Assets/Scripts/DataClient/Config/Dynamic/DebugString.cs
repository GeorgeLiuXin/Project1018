...
namespace XWorld.DataConfig
{
    ...
    public class DebugString : System.ICloneable
    {
    ...
    public class TableDebugString : XWorld.DataConfig.TableBase
    {
        
        public List<DebugString> m_configList = new List<DebugString>();
        
        public void LoadData(XWorld.DataConfig.DebugString codeValue)
        {
        ...
        public DebugString GetData(int rowIdx)
        {
