...
namespace XWorld.DataConfig
{
    ...
    public class AICheckCondition : System.ICloneable
    {
    ...
    public class TableAICheckCondition : XWorld.DataConfig.TableBase
    {
        
        public List<AICheckCondition> m_configList = new List<AICheckCondition>();
        
        public void LoadData(XWorld.DataConfig.AICheckCondition codeValue)
        {
        ...
        public AICheckCondition GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                AICheckCondition data = new AICheckCondition();
                int j = 0;
