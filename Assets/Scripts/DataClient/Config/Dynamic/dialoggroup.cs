...
namespace XWorld.DataConfig
{
    ...
    public class dialoggroup : System.ICloneable
    {
        
        public int ID;
        
        public int DefDialogGroupID;
        
        public string BackGroups;
    ...
    public class Tabledialoggroup : XWorld.DataConfig.TableBase
    {
        
        public List<dialoggroup> m_configList = new List<dialoggroup>();
        
        public void LoadData(XWorld.DataConfig.dialoggroup codeValue)
        {
        ...
        public dialoggroup GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                dialoggroup data = new dialoggroup();
                int j = 0;
                ...
                if (subValues != null && subValues.Length == GetRowCount())
                {
                    ...
                    j = j + 1;
                    data.DefDialogGroupID = ClientConfigManager.ToInt32(subValues[j]);
                    j = j + 1;
                    data.BackGroups = (subValues[j]);
                    j = j + 1;
