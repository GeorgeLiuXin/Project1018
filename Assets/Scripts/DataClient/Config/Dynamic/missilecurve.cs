...
namespace XWorld.DataConfig
{
    ...
    public class missilecurve : System.ICloneable
    {
        
        public int CurveID;
        
        public string CltPath;
    ...
    public class Tablemissilecurve : XWorld.DataConfig.TableBase
    {
        
        public List<missilecurve> m_configList = new List<missilecurve>();
        
        public void LoadData(XWorld.DataConfig.missilecurve codeValue)
        {
        ...
        public missilecurve GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                missilecurve data = new missilecurve();
                int j = 0;
                ...
                {
                    data.CurveID = ClientConfigManager.ToInt32(subValues[j]);
                    j = j + 1;
                    data.CltPath = (subValues[j]);
                    j = j + 1;
                    data.Up = (subValues[j]);
                    j = j + 1;
                    data.Fly = (subValues[j]);
                    j = j + 1;
                    data.Down = (subValues[j]);
                    j = j + 1;
