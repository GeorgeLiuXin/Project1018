...
namespace XWorld.DataConfig
{
    ...
    public class LocationDesStr : System.ICloneable
    {
    ...
    public class TableLocationDesStr : XWorld.DataConfig.TableBase
    {
        
        public List<LocationDesStr> m_configList = new List<LocationDesStr>();
        
        public void LoadData(XWorld.DataConfig.LocationDesStr codeValue)
        {
        ...
        public LocationDesStr GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                LocationDesStr data = new LocationDesStr();
                int j = 0;
