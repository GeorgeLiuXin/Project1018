...
namespace XWorld.DataConfig
{
    ...
    public class nodecommoncheckgroup : System.ICloneable
    {
    ...
    public class Tablenodecommoncheckgroup : XWorld.DataConfig.TableBase
    {
        
        public List<nodecommoncheckgroup> m_configList = new List<nodecommoncheckgroup>();
        
        public void LoadData(XWorld.DataConfig.nodecommoncheckgroup codeValue)
        {
        ...
        public nodecommoncheckgroup GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                nodecommoncheckgroup data = new nodecommoncheckgroup();
                int j = 0;
