...
namespace XWorld.DataConfig
{
    ...
    public class SkillCheckCondition : System.ICloneable
    {
    ...
    public class TableSkillCheckCondition : XWorld.DataConfig.TableBase
    {
        
        public List<SkillCheckCondition> m_configList = new List<SkillCheckCondition>();
        
        public void LoadData(XWorld.DataConfig.SkillCheckCondition codeValue)
        {
        ...
        public SkillCheckCondition GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                SkillCheckCondition data = new SkillCheckCondition();
                int j = 0;
