...
namespace XWorld.DataConfig
{
    ...
    public class UIString : System.ICloneable
    {
    ...
    public class TableUIString : XWorld.DataConfig.TableBase
    {
        
        public List<UIString> m_configList = new List<UIString>();
        
        public void LoadData(XWorld.DataConfig.UIString codeValue)
        {
        ...
        public UIString GetData(int rowIdx)
        {
