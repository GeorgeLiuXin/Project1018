...
namespace XWorld.DataConfig
{
    ...
    public class MessageString : System.ICloneable
    {
    ...
    public class TableMessageString : XWorld.DataConfig.TableBase
    {
        
        public List<MessageString> m_configList = new List<MessageString>();
        
        public void LoadData(XWorld.DataConfig.MessageString codeValue)
        {
        ...
        public MessageString GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                MessageString data = new MessageString();
                int j = 0;
