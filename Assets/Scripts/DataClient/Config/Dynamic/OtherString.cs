...
namespace XWorld.DataConfig
{
    ...
    public class OtherString : System.ICloneable
    {
    ...
    public class TableOtherString : XWorld.DataConfig.TableBase
    {
        
        public List<OtherString> m_configList = new List<OtherString>();
        
        public void LoadData(XWorld.DataConfig.OtherString codeValue)
        {
        ...
        public OtherString GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                OtherString data = new OtherString();
                int j = 0;
