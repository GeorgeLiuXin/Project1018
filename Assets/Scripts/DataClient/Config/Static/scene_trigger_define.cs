...
namespace XWorld.DataConfig
{
    ...
    public class scene_trigger_define : System.ICloneable
    {
    ...
    public class Tablescene_trigger_define : XWorld.DataConfig.TableBase
    {
        
        public List<scene_trigger_define> m_configList = new List<scene_trigger_define>();
        
        public void LoadData(XWorld.DataConfig.scene_trigger_define codeValue)
        {
        ...
        public scene_trigger_define GetData(int rowIdx)
        {
        ...
        public override void LoadData(string content)
        {
            ...
            {
                scene_trigger_define data = new scene_trigger_define();
                int j = 0;
